...
def certify(*, official: OfficialSnapshot | None, serving: ProviderStatus | None, decision: SystemDecision | None, team_state: TeamState | None=None, hard_evidence_conflict: bool=False, evidence_acquisition_complete: bool=True, degraded_warnings: tuple[str, ...]=(), shadow_warnings: tuple[str, ...]=(), valid_until: str | None=None, now: datetime | None=None) -> CertificationResult:
    reasons = []
