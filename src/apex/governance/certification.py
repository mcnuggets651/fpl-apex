...
def certify(*, official: OfficialSnapshot | None, serving: ProviderStatus | None, decision: SystemDecision | None, team_state: TeamState | None=None, hard_evidence_conflict: bool=False, degraded_warnings: tuple[str, ...]=(), shadow_warnings: tuple[str, ...]=(), valid_until: str | None=None) -> CertificationResult:
    reasons = []
