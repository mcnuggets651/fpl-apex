...
class ChampionAdmissionCertificate:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "season", _text(self.season, label="champion admission season"))
        object.__setattr__(self, "candidate_id", _sha256_id(self.candidate_id, label="champion candidate"))
        object.__setattr__(
            self,
            "qualification_artifact_id",
            _sha256_id(self.qualification_artifact_id, label="champion qualification artifact"),
        )
        object.__setattr__(
            self,
            "review_artifact_id",
        ...
        object.__setattr__(self, "reviewed_by", _text(self.reviewed_by, label="champion reviewer"))
        object.__setattr__(self, "reviewed_at", _text(self.reviewed_at, label="champion reviewed_at"))
        object.__setattr__(self, "reason", _text(self.reason, label="champion admission reason"))
...
class ProductionChampionGeneration:
    ...
    def __post_init__(self) -> None:
        ...
        for field in artifact_fields:
            object.__setattr__(
                self,
                field,
                _sha256_id(getattr(self, field), label=f"champion generation {field}"),
            )
        ...
        object.__setattr__(self, "authorized_by", _text(self.authorized_by, label="champion generation authorizer"))
        object.__setattr__(self, "authorized_at", _text(self.authorized_at, label="champion generation authorized_at"))
        object.__setattr__(self, "reason", _text(self.reason, label="champion generation reason"))
    ...
    def semantic_payload(self) -> dict[str, object]:
        return {
            ...
            "forecast_registry_generation_artifact_id": self.forecast_registry_generation_artifact_id,
            "forecast_model_id": self.forecast_model_id,
            "decision_policy_admission_artifact_id": self.decision_policy_admission_artifact_id,
            "decision_policy_id": self.decision_policy_id,
            "scenario_generator_admission_artifact_id": self.scenario_generator_admission_artifact_id,
            "scenario_generator_id": self.scenario_generator_id,
            "scenario_policy_admission_artifact_id": self.scenario_policy_admission_artifact_id,
