...
from scripts.openfpl_method_contract_preflight import validate_contract
...
def test_governed_method_contract_is_self_consistent():
    ...
    assert validate_contract(contract, policy, locks) == ()
...
def test_contract_rejects_score_dependent_feature_reintroduction():
    ...
    errors = validate_contract(mutated, policy, locks)
